...
Priority order: clinical trials and human translational studies first, then
reviews and preclinical work, so a partial run still yields the rows that
matter most. Local paths are written back into index.tsv and curated.json.
"""
import csv
import json
import os
...
PRIORITY = {"clinical_trial": 0, "translational_human": 1, "systematic_review": 2,
            "review": 3, "preclinical": 4, "mechanistic": 5}
MAX_FETCH = 140
